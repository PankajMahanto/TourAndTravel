...
<head>
   ...
   <title>Destinationping cart</title>
...
<body>
   ...
   <section class="Destinationping-cart">

      <h1 class="title">Location added</h1>
      ...
      <div class="cart-total">
         ...
         <a href="Destination.php" class="option-btn">continue Travelling</a>
