   ...
   <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
         <div class="carousel-item active" data-bs-interval="10000">
            <img src="./images/2.avif" class="w-100 h-100" alt="...">
         ...
         <div class="carousel-item" data-bs-interval="2000">
            <img src="./images/3.jpg" class="w-100 h-100" alt="">
            <div class="carousel-caption d-none d-md-block">
               <a href="Destination.php" class="btn">Destination</a>
            </div>
         </div>
         <div class="carousel-item">
            <img src="./images/1.avif" class="w-100 h-100" alt="...">
   ...
   <section class="home-category">
      ...
      <div class="box-container">
         ...
         <div class="box">
            ...
            <a href="category.php?category=Cox" class="btn">Cox's Bazar</a>
         </div>
         ...
         <div class="box">
            ...
            <a href="category.php?category=Bandarban" class="btn">Bandarban</a>
         </div>
         ...
         <div class="box">
            ...
            <a href="category.php?category=Sajek" class="btn">Sajek</a>
         </div>
         ...
         <div class="box">
            ...
            <a href="category.php?category=Hotel" class="btn">Hotel</a>
         </div>
