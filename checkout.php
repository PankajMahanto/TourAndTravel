      ...
      <form action="" method="POST">
         ...
         <div class="flex">
            ...
            <div class="inputBox">
               ...
               <input type="text" name="flat" placeholder="e.g. House No" class="box" required>
            </div>
            <div class="inputBox">
            ...
            <div class="inputBox">
               <span>City :</span>
               <input type="text" name="city" placeholder="e.g. Uttora" class="box" required>
            </div>
            <div class="inputBox">
               <span>State :</span>
            ...
            <div class="inputBox">
               ...
               <input type="number" min="0" name="postal_code" placeholder="e.g. 1234" class="box" required>
            </div>
         </div>
