...
<body>
   ...
   <section class="wishlist">
      ...
      <h1 class="title">Locations added</h1>
         ...
         ?>
               <form action="" method="POST" class="box">
                  ...
                  <div class="latest-btn">
                     <button type="submit" class="option-buttn" name="add_to_cart"><i class="fas fa-cart-Destinationping fa-bounce" style=" --fa-bounce-start-scale-x: 1; --fa-bounce-start-scale-y: 1; --fa-bounce-jump-scale-x: 1; --fa-bounce-jump-scale-y: 1; --fa-bounce-land-scale-x: 1; --fa-bounce-land-scale-y: 1; "></i></button>
      ...
      <div class="wishlist-total">
         ...
         <a href="Destination.php" class="option-btn">continue Destinationping</a>
